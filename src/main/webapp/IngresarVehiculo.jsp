<%-- 
    ...
    Created on : 22-11-2020, 17:58:03
                    ...
                    <table>
                       ...
                       <tr><td><div id="content" style="padding:20px">
                            <label>Disponible</label>
                                <input type="radio" id="Disponible" name="estado_ve" value="Disponible" style="margin-right: 10px" required>
                            <label>No Disponible</label>
                                <input type="radio" id="nodisponible" name="estado_ve" value="No Disponible" required>
                        </div></td></tr>
