            ...
            <h1 align="center">Registro</h1>
                <form action="insertarusuario" method="post">
                    <table>
                        ...
                        <tr><td colspan="2"><label>Apellidos: </label></td></tr>
                        ...
                        <tr><td colspan="2"><label>Correo: </label></td></tr>
                        <tr><td><input type="email" name="mail" required</td></tr>
                        <tr><td colspan="2"><label>Telefono: </label></td></tr>
                        <tr><td><input type="text" name="fono" required></td></tr>
                        <tr><td colspan="2"><label>Contraseña: </label></td></tr>
                        <tr><td><input type="password" name="pass" required></td></tr>
                        <tr><td colspan="2"><label>Verificar contraseña: </label></td></tr>
